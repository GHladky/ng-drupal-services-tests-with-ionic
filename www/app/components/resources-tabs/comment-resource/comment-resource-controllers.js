...
var anonCommentResourceControllers = angular.module('resources.comment-resource.controllers', ['CommentResourceModules', 'drupalBaseModules']);


/* Comment Resource Controller */
anonCommentResourceControllers.controller('ResourcesCommentResourceCtrl', 
		   ['$scope', 'BaseResource', 'CommentResource', 'CommentResourceChannel',
    function($scope,   BaseResource,   CommentResource,   CommentResourceChannel) {
