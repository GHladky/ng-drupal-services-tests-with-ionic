...
var anonFileResourceControllers = angular.module('resources.file-resource.controllers', ['FileResourceModules']);


/* File Resource Controller */
anonFileResourceControllers.controller('ResourcesFileResourceCtrl', 
		   ['$scope', 'FileResource', 'FileResourceChannel',
    function($scope,   FileResource,   FileResourceChannel) {
