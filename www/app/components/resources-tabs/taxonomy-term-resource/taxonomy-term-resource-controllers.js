...
var anonTaxonomyTermResourceControllers = angular.module('resources.taxonomy-term-resource.controllers', ['TaxonomyTermResourceModules']);


/* TaxonomyTerm Resource Controller */
anonTaxonomyTermResourceControllers.controller('ResourcesTaxonomyTermResourceCtrl', 
		   ['$scope', 'TaxonomyTermResource', 'TaxonomyTermResourceChannel',
    function($scope,   TaxonomyTermResource,   TaxonomyTermResourceChannel) {
